...
class Sample:
    ...
    doc_list: dict[str, list[str]] = field(default_factory=lambda: defaultdict(list))
    doc_id_list: dict[str, list[str]] = field(default_factory=lambda: defaultdict(list))

    is_query_rep: bool = False
    is_doc_rep: bool = False
    is_rsp_rep: bool = False
    rsp_rep_ratio: float = 0
    lap_ratio: float = 0

    exact_match: bool = False
    is_entail: bool = False
    f1: float = 0.0
    query_num: int = 0
    is_format: bool = False
    in_group_idx: int | None = None
