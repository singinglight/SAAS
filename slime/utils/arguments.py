...
def get_slime_extra_args_provider(add_custom_arguments=None):
    def add_slime_arguments(parser):
        ...
        def add_tool_arguments(parser):
            ...
            parser.add_argument(
                "--retrieval-em-different",
                action="store_true",
                default=False,
            )
            parser.add_argument(
                "--disable-search-tokens-for-first-half",
                action="store_true",
                default=False,
            )
            parser.add_argument(
                "--disable-search-first-n",
                type=int,
                default=None,
            )
            parser.add_argument(
                "--normal-generate-function-path",
                type=str,
                default=None,
            )
            parser.add_argument(
        ...
        parser = add_tool_arguments(parser)
        reset_arg(
            parser,
            "--custom-config-path",
            type=str,
